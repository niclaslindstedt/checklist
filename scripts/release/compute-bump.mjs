...
//
// This mirrors AGENTS.md → "Semver and release cadence": a new feature
// or any visible behaviour change (including removing or deprecating a
// feature) is at least a minor; a pure fix is a patch; and a change an
// older build can't survive — a break to the persisted-data shape, or a
