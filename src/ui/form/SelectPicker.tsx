...
// Custom <select> replacement built on FloatingPanel, cloned from the
// budget project. The trigger is styled like the project's
// `field-input`; the panel is a `role="listbox"` of `role="option"`
// buttons. Full keyboard nav: ArrowUp / Down to move highlight,
// Home / End to jump, Enter / Space to commit, Escape to dismiss
// without committing.
