...
// Presentational building blocks shared by the settings tabs, mirroring
// the budget project's `tabs/shared`. Pared down: the checklist's
// sections are short, so there's no auto-collapse machinery.
...
/** A three/four-button segmented control. */
