// App-chrome glyphs: the header menu, navigation, and modal title icons.
// Budget reaches for `lucide-react`; the checklist inlines the handful it
// actually uses. Paths are traced from Lucide's 24×24 grid so they share
// its weight.
...
/** A warning triangle with an exclamation — the title glyph for a
...
/** A circled question mark — the title glyph for a neutral
 * confirmation. */
...
// A closed padlock — marks the at-rest encryption state in the cloud-sync
// command centre's Details grid (paired with `ShieldIcon` for the "off" case).
...
/** An artist's palette — the Theme / appearance tab marker. */
