...
// your passphrase", "unlocking your lists") rather than reusing the generic
...
> = {
  ...STEP_MESSAGE_KEY,
  derivingKey: "settings.storage.unlockStepDerivingKey",
  decrypting: "settings.storage.unlockStepDecrypting",
  finalizing: "settings.storage.unlockStepFinalizing",
};
