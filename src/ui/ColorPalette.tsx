...
// and is handed the new colour on every pick. Ported from budget's
// `ColorPalette`, trimmed to the checklist's needs (no roving-tabindex
// hook — the swatches are plain radios in tab order). The palette itself
// lives in `namespace-colors.ts`.
