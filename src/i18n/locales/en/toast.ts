...
const toast = {
  ...
  listReset: "Reset “{name}”",
  resetScheduleSet: "Scheduled resets for “{name}”",
  resetScheduleCleared: "Removed the reset schedule from “{name}”",
  ...
  listCreatedFromTemplate: "Created list “{name}” from the template",
  templateCreated: "Saved “{name}” as a template",
  templateRenamed: "Renamed template to “{name}”",
  templateDeleted: "Deleted template “{name}”",
