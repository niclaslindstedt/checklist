// Barrel for the achievements feature. Mirrors budget's
// `src/data/achievements/index.ts`: the catalog, the manual-unlock bus, the
// watcher, the pure derive helper, and the shared types / tier constants.
