...
// native counterpart of the web app's `src/storage/backend-preference.ts`,
// collapsed to the only choice the native app currently offers (on-device vs
// iCloud) and backed by AsyncStorage instead of localStorage.
//
...
const BACKEND_KEY = "checklist:native:backend";
