...
export const RULES: StoreRules = {
  ...
  brand: {
    ...
    marketingUrl: "https://checklist.niclaslindstedt.se/",
    ...
    // behaviour does.
    privacyUrl: "https://apps.agilator.se/checklist/privacy/",
    supportUrl: "https://apps.agilator.se/checklist/support/",
  },

  // Checklist ships on the App Store alone. There is no Mac App Store record and
  ...
  apple: {
    // A checklist. PRODUCTIVITY is where somebody looking for one looks;
    // UTILITIES second because it is small, local and does one thing.
    ...
    advisory: {
      ...
      // An item on a list is whatever the reader typed. The app records
      // nothing medical of its own, offers no dosage and gives no advice —
      // the question asks what the APP provides, not what a reader may write
      // in a free field.
