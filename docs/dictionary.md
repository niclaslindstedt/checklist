...
| **Keyboard nav bar** / **edit nav bar** / **up/down buttons above the keyboard** / **navigate items while editing** | `src/ui/EditNavBar.tsx`; `ActiveEditor` (`src/ui/edit-nav.ts`); `activeEditor` + `moveEdit` (`src/ui/ChecklistView.tsx`); `onActiveChange` (`src/ui/ChecklistRowEditor.tsx`). [→](overview.md#keyboard-nav-bar) |
