...
| **Browser back** / **back button** / **forward button** / **go back to the previous list** / **router navigation** / **history entries** | `useNavHistory`, `NavDestination`, `markNavigation`, `readNavDestination` (`src/app/use-nav-history.ts`); `destination` / `applyDestination` / `navVerbs` in `src/app/App.tsx`. [→](overview.md#browser-back--forward) |
